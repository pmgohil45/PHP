...
<body>
	<div class="main">  	
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="signup">
				<form method="POST" action="sub3DeleteData.php">
					<label for="chk" aria-hidden="true" style="font-family:Century Schoolbook;">Delete</label>
					<input type="number" name="s3id" id="s3id" placeholder="I'd Number" required="">
					<input class="button" type="submit" id="submit" name="submit" value="Submit">
				</form>
				
				<?php
					$sel = "select `s3id`,`s3name` from `sub3pdfdownload`";
		...
		<table align="center" style="color:#9370DB;">
					...
					?>
						<tr>
							<td style="padding:1vh"><?php echo $row['s3id']; ?></td>
							<td style="padding:1vh"><?php echo $row['s3name']; ?></td>
						</tr>
					<?php
						}
					?>
