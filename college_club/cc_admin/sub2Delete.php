...
<body>
	<div class="main">  	
		<input type="checkbox" id="chk" aria-hidden="true">
			...
			<div class="signup">
				<form method="POST" action="sub2DeleteData.php">
					<label for="chk" aria-hidden="true" style="font-family:Century Schoolbook;">Delete</label>
					<input type="number" name="s2id" id="s2id" placeholder="I'd Number" required="">
					<input class="button" type="submit" id="submit" name="submit" value="Submit">
				</form>
				
				<?php
					$sel = "select `s2id`,`s2name` from `sub2pdfdownload`";
		...
		<table align="center" style="color:#9370DB;">
					...
					?>
						<tr>
							<td style="padding:1vh"><?php echo $row['s2id']; ?></td>
							<td style="padding:1vh"><?php echo $row['s2name']; ?></td>
						</tr>
					<?php
						}
					?>
