...
<?php
	...
	$select = "select * from `login` where `lemail`='$lemail'";
	$res = mysqli_query($con,$select);
	$emailCheck = $_SESSION['lemail'] = $lemail;
	if($lemail == $emailCheck)
	{*/
?>
...
<body>
                                ...
                                <div class="program__content">
                                    ...
                                    if ($resSyllabus == TRUE) {
                                        while ($rowSyllabus = mysqli_fetch_assoc($resSyllabus)) {
                                            $sid = $rowSyllabus['sid'];
                                    ?>
                                        <?php foreach ($resSyllabus as $file): ?>
											<tr>
											  <td><?php $file['name']; ?></td>
											  <h4><td><?php echo $file['sname']; ?></td></h4>
											  <!-- <td>(<?php //echo floor($file['size'] / 1000) . ' KB'; ?>)</td>-->
											  <td><a href="adminSite\downloads\syllabusDownload.php?sid=<?php echo $file['sid'] ?>" class="boxed-btn5">Download</a></td>
											</tr>
										<?php endforeach;?>
                                    <?php
                                        }
                                ...
                                <div class="program__content">
                                    ...
                                    if ($resSub1 == TRUE) {
                                        while ($rowSub1 = mysqli_fetch_assoc($resSub1)) {
                                            $s1id = $rowSub1['s1id'];
                                    ?>
										<?php foreach ($resSub1 as $file): ?>
											<tr>
											  <td><?php $file['name']; ?></td>
											  <h4><td><?php echo $file['s1name']; ?></td></h4>
											  <!-- <td>(<?php //echo floor($file['size'] / 1000) . ' KB'; ?>)</td>-->
											  <td><a href="adminSite\downloads\sub1Download.php?s1id=<?php echo $file['s1id'] ?>" class="boxed-btn5">Download</a></td>
											</tr>
										<?php endforeach;?>
                                    <?php
                                        }
                                ...
                                <div class="program__content">
                                    ...
                                    if ($resSub2 == TRUE) {
                                        while ($rowSub2 = mysqli_fetch_assoc($resSub2)) {
                                            $s2id = $rowSub2['s2id'];
                                    ?>
                                        <?php foreach ($resSub2 as $file): ?>
											<tr>
											  <td><?php $file['name']; ?></td>
											  <h4><td><?php echo $file['s2name']; ?></td></h4>
											  <!-- <td>(<?php //echo floor($file['size'] / 1000) . ' KB'; ?>)</td>-->
											  <td><a href="adminSite\downloads\sub2Download.php?s2id=<?php echo $file['s2id'] ?>" class="boxed-btn5">Download</a></td>
											</tr>
										<?php endforeach;?>
                                    <?php
                                        }
                                ...
                                <div class="program__content">
                                    ...
                                    if ($resSub3 == TRUE) {
                                        while ($rowSub3 = mysqli_fetch_assoc($resSub3)) {
                                            $s3id = $rowSub3['s3id'];
                                    ?>
                                        <?php foreach ($resSub3 as $file): ?>
											<tr>
											  <td><?php $file['name']; ?></td>
											  <h4><td><?php echo $file['s3name']; ?></td></h4>
											  <!-- <td>(<?php //echo floor($file['size'] / 1000) . ' KB'; ?>)</td>-->
											  <td><a href="adminSite\downloads\sub3Download.php?s3id=<?php echo $file['s3id'] ?>" class="boxed-btn5">Download</a></td>
											</tr>
										<?php endforeach;?>
                                    <?php
                                        }
                                ...
                                <div class="program__content">
                                    ...
                                    if ($resSub4 == TRUE) {
                                        while ($rowSub4 = mysqli_fetch_assoc($resSub4)) {
                                            $s4id = $rowSub4['s4id'];
                                    ?>
                                        <?php foreach ($resSub4 as $file): ?>
											<tr>
											  <td><?php $file['name']; ?></td>
											  <h4><td><?php echo $file['s4name']; ?></td></h4>
											  <!-- <td>(<?php //echo floor($file['size'] / 1000) . ' KB'; ?>)</td>-->
											  <td><a href="adminSite\downloads\sub4Download.php?s4id=<?php echo $file['s4id'] ?>" class="boxed-btn5">Download</a></td>
											</tr>
										<?php endforeach;?>
                                    <?php
                                        }
	...
	<!-- download_code_area_start  -->
			<div class="popular_program_area section__padding " id="codes">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="section_title text-center">
								<h3>Code for Journal</h3><br>
							</div>
						</div>
					</div>
					<div class="tab-content" id="nav-tabContent">
							...
							<div class="row">
								<div class="col-lg-4 col-md-6">
									<div class="single__program">
										<div class="program__content">
											<h4>C#</h4>
											<a href="https://github.com/pmgohil43/C_Sharp" class="boxed-btn5">Click Here</a>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="single__program">
										<div class="program__content">
											<h4>Java</h4>
											<a href="https://github.com/pmgohil43/JAVA" class="boxed-btn5">Click Here</a>
										</div>
									</div>
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="single__program">
										<div class="program__content">
											<h4>OS</h4>
											<a href="https://github.com/pmgohil43/OS" class="boxed-btn5">Click Here</a>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="footer_widget">
                                ...
                                <div class="socail_links" align="center">
                                    ...
                                    <p class="socail_icons" style="">
                                        ...
                                        <a class="fa fa-telegram" id="socail_link" href="https://t.me/pm_gohil45"></a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
/*	}
	...
	{
		echo "<script>alert('Session expier...!');
